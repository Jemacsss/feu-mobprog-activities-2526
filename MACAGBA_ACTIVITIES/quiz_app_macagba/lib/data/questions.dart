...
// Category 1
  ...
  'Evolutions': [
    ...
    QuizQuestion(
      ...
      imagePath: 'assets/images/gyrados.png',
    ),
    QuizQuestion(
      ...
      imagePath: 'assets/images/steelix.png',
    ),
    QuizQuestion(
...
// Category 2
  ...
  'Gym Leaders and Elite 4': [
    ...
    QuizQuestion(
      ...
      imagePath: 'assets/images/rai.png',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      correctAnswer: 'Grass',
      imagePath: 'assets/images/vile.png',
    ),
    QuizQuestion(
...
// Category 3
  ...
  'Pokemon Games': [
    QuizQuestion(
      ...
      imagePath: 'assets/images/kanto.png',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      imagePath: 'assets/images/mega.png',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      imagePath: 'assets/images/dyna.png',
    ),
  ],
};
